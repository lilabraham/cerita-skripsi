      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-white font-heading mb-4">
            Ruang <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-teal-400">Diskusi</span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Punya pertanyaan seputar HIV/AIDS? Atau ingin berbagi pandangan? Tulis di sini! Ruang ini aman, bebas stigma, dan kamu bisa bertanya secara anonim.
          </p>
        </div>

        {/* Kotak Input Komentar */}
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8 mb-12 shadow-2xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-white/10 px-4 py-2 text-white focus:outline-none focus:border-indigo-500 transition-colors placeholder:text-gray-600"
              />
            </div>
            <textarea
              ...
              rows={3}
              className="w-full bg-black/20 border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-indigo-500 transition-colors resize-none mt-2 placeholder:text-gray-600"
            />
            <div className="flex justify-end mt-2">
              <button
                type="submit"
                disabled={!newComment.trim()}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium transition-all"
              >
                Kirim <Send size={16} />
              </button>
            </div>
        ...
        <div className="space-y-6">
          <h3 className="text-xl font-bold text-white mb-6">Komentar Terbaru</h3>
            ...
            {comments.map((comment) => (
              ...
              >
                <div className="flex gap-4">
                  {/* Avatar */}
                  <div className={cn("w-10 h-10 rounded-full flex items-center justify-center shrink-0 font-bold text-white", comment.avatarColor)}>
                  ...
                  <div className="flex-1">
                    ...
                    <button className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-rose-400 transition-colors group">
